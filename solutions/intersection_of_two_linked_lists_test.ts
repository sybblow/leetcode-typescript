...
Deno.test("160. Intersection of Two Linked Lists", () => {
  ...
  assertStrictEquals(getIntersectionNode(headA1, headB1), intersection1);
  ...
  assertStrictEquals(getIntersectionNode(headA3, headB3), null);
});
